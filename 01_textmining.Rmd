...
Goal: Make a basic word cloud for the novel, _Sense and Sensibility_, `pride_prej_novel`
...
```{r}
pp_word_freq <- pp_minus_stopwords %>% 
  count(word, sort = TRUE)
pp_word_freq
```
